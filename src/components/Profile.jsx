...
export const Profile = () => {
  return (
    <>
      <section className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2  justify-center items-center content-center h-auto my-40 mx-auto w-full sm:w-10/12 lg:w-9/12">
        <div className="w-auto mx-auto">
          <img src={ProfilePicture} className="rounded-lg mx-auto w-10/12 xl:w-11/12" alt="" />
        </div>
