...
export const CardProjects = ({
  ...
  developed_in.map((item) => {
    //console.log(item);
  });

  return (
    <div className="flex flex-col bg-yellow-primary w-full h-auto rounded-xl">
      <img
        src={capture}
        className="h-auto w-auto my-5 mx-5 object-cover rounded-md"
        alt=""
      />

      <div className="flex flex-col w-auto bg-black-primary rounded-r-lg">
